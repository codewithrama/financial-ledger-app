    ...
    return (
        <div className={styles.onBoardingContainer}>
            ...
            <div className={styles.onBoardingText}>
                ...
                <p>
                    Define Your finanical boundaries. This anchor points creates
                    the structure for your ethereal discipline
                </p>
            </div>

            <div className={styles.onBoardingCard}>
                <div className={styles.incomeSection}>
                    <p className={styles.incomeTitle}>
                        Monthly Income Target (USD)
                    </p>
                ...
                <div className={styles.infoBadge}>
                    ...
                    <p>
                        Note : once set the limit is locked for 3 months to ensure
                        accurate financial insights and discipline
                    </p>
                </div>
